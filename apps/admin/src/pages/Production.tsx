...
const COLUMNS: {
  ...
  { key: "confirmed", label: "In Production", dot: "#3b82f6", next: "shipped", nextLabel: "Mark Dispatched" },
  { key: "shipped", label: "Dispatched", dot: "#f59e0b", next: "delivered", nextLabel: "Mark Delivered" },
