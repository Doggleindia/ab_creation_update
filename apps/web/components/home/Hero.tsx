      ...
      <div className="max-w-[1300px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center mb-16 md:mb-24">
          ...
          <div className="max-w-xl">
            <h1 className="text-5xl md:text-[64px] font-bold text-[#111827] leading-[1.15] mb-6 tracking-tight">
              Printed for You.<br />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-[#ff6200] hover:bg-[#e65800] text-white px-7 py-3.5 rounded-full text-[16px] font-bold flex items-center justify-center transition-all shadow-[0_8px_20px_-6px_rgba(255,98,0,0.6)]">
                Customize Product
        ...
        <div className="w-full border border-gray-200 rounded-2xl p-2 md:p-3">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
            {/* Feature 1 */}
            <div className="bg-[#f8f9fa] rounded-xl py-5 px-4 flex items-center justify-center gap-3">
